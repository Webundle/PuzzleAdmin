...
$(function() {
    ...
    var initialPreview = $('#files_preview').val().split(',');
    var fileType = $('#files_type').val();
    ...
    $('.file-input').fileinput({
        ...
        initialPreviewFileType: fileType, // image is the default and can be overridden in config below
